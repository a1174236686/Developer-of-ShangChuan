...
Page({
  ...
  data: {
    serverUrl: serverUrl,
    topImgData: {
      src: '../../img/joinZy.png', mode: 'scaleToFill'
    },
    /**
     * 表单数据绑定对象
     * id 身份证号码
    ...
    formData: [
      ...
      { label: '工作经历', placeholder: '请输入您的工作经历...', mapping: 'workExperience' ,render:'workExperience'},
    ],
...
console.log(this.data.formData)
  ...
  postMsg: function () {
    ...
    let tokenInfo = wx.getStorageSync('tokenInfo')
    wx.request({
      url: app.globalData.serverUrl + '/staff/save',
      header: { 'token': tokenInfo.token },
      method: 'post',
      data: {
        // platform: 'wx',
