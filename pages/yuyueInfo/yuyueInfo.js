...
Page({
  ...
  data: {
    infoList: [
      ...
      {icon: '',name: '区域', value: '', type: 'region'},
      {icon: '',name: '拍摄地点', value: '', type: 'region'},
      {icon: '',name: '拍摄对象', value: '', type: 'region'},
      {icon: '',name: '拍摄时间', value: '戚戚', type: 'region'}],
      noEdit: false,
  },
   ...
   */
  onShow: function () {
    console.log(wx.getStorageSync('enterTime'),wx.getStorageSync('sessionInfo'))
  },
